...
import { seedExitProfiles } from './03-exit-profiles.seed';
import { seedCyclesAndCourses } from './04-cycles-courses.seed';
...
async function runSeeds() {
  try {
    ...
    console.log('🎯 Creando perfiles de salida y descriptores operativos...');
    await seedExitProfiles(AppDataSource);
    console.log('');

    console.log('📚 Creando ciclos y cursos educativos...');
    await seedCyclesAndCourses(AppDataSource);
    console.log('');
